...
class ChatUser
{
    ...
    {
        $query = "
		INSERT INTO chat_user_table (user_name, user_email, user_password, user_status, user_created_on, user_verification_code) 
        ...
        // $statement->bindParam(':user_profile', 'default.png');
